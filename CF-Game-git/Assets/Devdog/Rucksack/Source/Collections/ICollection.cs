...
namespace Devdog.Rucksack.Collections
{
        ...
        where TElementType : IEquatable<TElementType>
    {
        ...
        event EventHandler<CollectionRemoveResult> OnRemovedItem;
        ...
        Result<CollectionRemoveResult> Remove(TElementType item, int amount = 1);
    ...
    public interface ICollection : IReadOnlyCollection
    {
        ...
        Result<CollectionRemoveResult> RemoveBoxed(object item, int amount = 1, CollectionContext context = null);
