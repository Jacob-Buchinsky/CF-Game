...
namespace Devdog.Rucksack.UI
{
    ...
    public class CurrencyCollectionUI : UIQueuedMonoBehaviour<CurrencyUI>
    {
        [SerializeField]
        ...
        public ICurrencyCollection<ICurrency, double> collection
        {
            ...
            set
            {
                ...
                if (_collection != null)
                {
                    ...
                    repaintableElements = new CurrencyUI[_repaintCurrencies.Length];
        ...
        protected virtual ICurrencyCollection<ICurrency, double> FindCollection()
        {
            ...
            logger.Warning($"Collection with name {_collectionName} not found!", this);
            return null;
        }
        
        protected override CurrencyUI CreateUIElement(int index)
        {
        ...
        protected override void Repaint(int slot)
        {
            ...
            {
                repaintableElements[slot]?.Repaint(collection.GetAmount(_repaintCurrencies[slot]));
