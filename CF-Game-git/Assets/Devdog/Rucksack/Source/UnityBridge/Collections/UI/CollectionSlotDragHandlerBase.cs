...
namespace Devdog.Rucksack.UI
{
        ...
        where T : class, IEquatable<T>
    {
        ...
        {
            var clone = UnityEngine.Object.Instantiate(gameObject, eventData.position, Quaternion.identity, canvasParent.transform).GetComponent<RectTransform>();
            clone.transform.localPosition = new Vector3(eventData.position.x, eventData.position.y, 0f);
        ...
        public virtual void OnEndDrag(PointerEventData eventData)
        {
            ...
            {
                var model = DragAndDropUtility.currentDragModel;
