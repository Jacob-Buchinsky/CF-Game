...
namespace Devdog.Rucksack.Vendors
{
        ...
        where T : class, IEquatable<T>, IIdentifiable, IStackable, ICloneable
    {
        ...
        public UNetVendor(Guid vendorGuid, string vendorCollectionName, Guid vendorCollectionGuid, NetworkIdentity ownerIdentity, ICollection<IVendorProduct<T>> collection, ICurrencyCollection<ICurrency, double> currencies = null)
            : base(collection, currencies)
        {
