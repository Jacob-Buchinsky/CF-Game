...
{
    public class UNetEquippableItemInstance : UnityEquippableItemInstance, INetworkItemInstance
    {
        // Used for (de) serialization
        public UNetEquippableItemInstance()
        { }
        
        public UNetEquippableItemInstance(Guid ID, IUnityEquippableItemDefinition itemDefinition)
