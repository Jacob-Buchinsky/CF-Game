...
namespace Devdog.Rucksack
{
    public class UNetActionsBridge : UNetGeneralActionsBridge //, ICollectionBridge
    {
        ...
        protected UNetSpawnReplicator spawnReplicator;
        ...
        {
            spawnReplicator = new UNetSpawnReplicator(this, logger);
...
//        }
        ...
        #region Item spawning and un-spawning
        ...
        [Server]
        public void Server_UnSpawnItemOnClient(UnSpawnItemMessage data)
        {
            TargetRpc_UnSpawnItem(connectionToClient, data);
        }
        ...
        {
            spawnReplicator.TargetRpc_UnSpawnItem(target, data);
        }
