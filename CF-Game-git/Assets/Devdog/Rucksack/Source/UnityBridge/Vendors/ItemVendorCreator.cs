...
namespace Devdog.Rucksack.Vendors
{
    public class ItemVendorCreator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            vendor = new UnityVendor<IItemInstance>(_vendorGuid.guid, _vendorCollectionName, _vendorCollectionGuid.guid, collection, new InfiniteCurrencyCollection()); // TODO: Make currency customizable
