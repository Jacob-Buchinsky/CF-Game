...
namespace Devdog.Rucksack.Vendors
{
        ...
        where T : class, IEquatable<T>, IIdentifiable, IStackable, ICloneable
    {
        ...
        public UnityVendor(Guid vendorGuid, string vendorCollectionName, Guid vendorCollectionGuid, ICollection<IVendorProduct<T>> collection, ICurrencyCollection<ICurrency, double> currencies = null)
